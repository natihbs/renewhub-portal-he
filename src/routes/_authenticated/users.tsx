...
function UserTableRow({
  ...
  return (
    ...
    >
      ...
      <TableCell>
        {user.active ? <Badge className="bg-[color:var(--success)]/15 text-success-foreground hover:bg-[color:var(--success)]/15">פעיל</Badge> : <Badge variant="outline">מושבת</Badge>}
      </TableCell>
