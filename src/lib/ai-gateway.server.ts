...
// The Responses provider reuses this (see `ai-responses-api`) — pass `fetch` into createOpenAI.
...
export function createLovableAiGatewayProvider(
  ...
  const provider = createOpenAICompatible({
    ...
    // OpenAI structured output needs strict json_schema; without this the SDK sends json_object (schema not enforced).
