...
// Both read the SAME scope-home derivations the dashboards use
// (buildScopeTeamRows / buildActivityCenterBoard / targetReadiness), so the
// two screens can never disagree about who is missing a target. Nothing here
// derives a number of its own, and no percentage is shown for target
// readiness: a set of teams may mix KPI profiles, and a combined "% of target"
// across מיועדות and יעד would be a fabricated unit.
import { useState } from "react";
import { Building2, ChevronDown, Target, UsersRound } from "lucide-react";
